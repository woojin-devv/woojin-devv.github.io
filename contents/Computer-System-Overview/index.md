...
description: "ch 1 학습목표 시스템의 기본 요소와 그 사이 관계 설명 프로세서에 의해 명령어가 수행 되는 처리 단계를 설명 인터럽트의 개념 이해 및 프로세서가 인터럽트를 사용하는 이유를 설명 컴퓨터 메모리 계층 구조 나열 및 설명층 구조 나열 멀티프로세서의 기본 특성과 멀티코어의 구조에 대해 설명"
date: 2025-09-25
...
heroImageAlt: "Operating System | Computer System Overview"
---
