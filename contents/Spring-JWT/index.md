...
description: "1. JWT란? JWT는 JSON Web Token 의 약어로, JSON 형식의 정보를 안전하게 주고받기 위한 토큰이다. 웹 애플리케이션에서는 주로 로그인 이후 사용자를 식별하기 위한 인증 수단으로 사용된다. 서버는 사용자가 로그인에 성공하면 JWT를 발급하고, 클라이언트는 이후 요청마"
date: 2026-05-24
slug: "/Spring-JWT/"
tags: [spring]
heroImageUrl: "https://img.youtube.com/vi/36lpDzQzVXs/maxresdefault.jpg"
heroImageAlt: "[Spring] JWT란? (세션과 비교)"
---
...
### 참고영상 
[JWT | 생활코딩](https://www.youtube.com/watch?v=36lpDzQzVXs)