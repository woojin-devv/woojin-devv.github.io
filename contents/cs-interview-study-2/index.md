---
title: "2주차 - 네트워크"
description: "38. 네트워크 기초 1 네트워크란? 노드와 링크가 서로 연결되어 있으며 리소스를 공유하는 집합을 의미함. 노드 : 서버, 라우터, 스위치 등 네트워크 장치 링크 : 유선 또는 무선과 같은 연결매체 (와이파이나 LAN) 트래픽 특정 시점에 링크 내에 흐르는 데이터의 양 트래픽이 많아졌다"
date: 2026-03-28
