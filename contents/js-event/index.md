---
title: "[JS] Event"
description: "JavaScript Event 정리 JavaScript에서 이벤트(Event) 는 사용자의 동작이나 브라우저의 상태 변화에 반응하여 특정 코드를 실행하는 방식이다. 예를 들어 사용자가 버튼을 클릭하거나, input에 커서를 올리거나, 페이지 로딩이 끝났을 때 JavaScript 함수를 "
date: 2026-05-26
slug: "/js-event/"
tags: ["javascript"]
